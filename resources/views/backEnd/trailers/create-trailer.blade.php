    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{url('/add-trailer')}}" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="title" class="span7 typeahead" id="title" required>                               
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea name="summary_of_story" class="cleditor" id="summary_of_story" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea name="cast" class="span7" id="cast" rows="3" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea name="shooting_location" class="span7" id="cast" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="script_writer" class="span7 typeahead" id="script_writer" required>                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="producer_name" class="span7 typeahead" id="producer_name" required>                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="director_name" class="span7 typeahead" id="director_name" required>                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="released_on" class="span7 typeahead" id="released_on">                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="released_no_of_hall" class="span7 typeahead" id="released_no_of_hall">                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="telecast_chanel" class="span7 typeahead" id="telecast_chanel">                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="on_air_time" class="span7 typeahead" id="on_air_time">                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls col-md-6">
                                <input type="text" name="video_url" class="span7 typeahead" id="video_url"  required>                               
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="trailer_image" class="input-file uniform_on" id="trailer_image" type="file" required>
                            </div>
                        </div> 
